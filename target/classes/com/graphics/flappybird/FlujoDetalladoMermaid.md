# Flujo Detallado del Juego (Mermaid)
...
## Flujo de estados globales

```mermaid
stateDiagram-v2
    [*] --> NoIniciado
    NoIniciado --> Corriendo: W o SPACE
    Corriendo --> Corriendo: saltos y actualizacion
    Corriendo --> P1Muerto: killPlayer(1)
    Corriendo --> P2Muerto: killPlayer(2)
    P1Muerto --> GameOver: killPlayer(2)
    P2Muerto --> GameOver: killPlayer(1)
    GameOver --> NoIniciado: R o W o SPACE (resetGame)
```
